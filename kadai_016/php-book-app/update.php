    ...
    <article class='registration'>
      ...
      <form action="update.php?id=<?= $_GET['id'] ?>" method="post" class="registration-form">
        <div>
          ...
          <input type="number" value="<?= $book['book_code'] ?>" name="book_code" min="0" max="100000000" required>

          <label for="book_name">書籍名</label>
          <input type="text" value="<?= $book['book_name'] ?>" name="book_name" maxlength="50" required>
          
          <label for="price">単価</label>
          <input type="number" value="<?= $book['price'] ?>" name="price" min="0" max="100000000" required>
          
          <label for="stock_quantity">在庫数</label>
          <input type="number" value="<?= $book['stock_quantity'] ?>" name="stock_quantity" min="0" max="100000000" required>
